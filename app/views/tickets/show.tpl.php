          ...
          <div class="row align-items-center">
            ...
            <?php if ($ticket['previous']) : ?>
              <h5>Повторная заявка с заявки
                <a href="/tickets/show?id=<?= (int)$ticket['previous']?>" style="text-decoration: none;"><i class="bi bi-box-arrow-in-right me-2"></i><?=  $ticket['previous'] ?></a>
              </h5>
            <?php endif; ?>
            </div>
      ...
      <div class="card m-0 p-0 shadow bg-body mb-2 rounded" style="height: 100%;">
        <div class="card-body">
          <div class="align-items-center">
            ...
            <h4><?=$ticket['name']?><a href="/clients/places/show?id=<?= $ticket['pid']?>" style="decoration-border: none;"><i class="bi bi-house-gear ms-2"></i></a></h4>
            ...
            <p>Подразделение:</p>
              ...
              <?php else : ?>
                <h4><?= $departament['name'] ?><a href="/clients/departaments/show?id=<?= $departament['id']?>" style="decoration-border: none;"><i class="bi bi-diagram-2 ms-2"></i></a></h4>
              <?php endif; ?>
            ...
            <p>Заявитель: </p>
              ...
              <?php else : ?>
                <h4><?= $client_id['name']?><a href="/clients/customers/show?id=<?= $client_id['id']?>" style="decoration-border: none;"><i class="bi bi-person-gear ms-2"></i></a></h4>
              <?php endif; ?>
